...
const fps = document.forms.modes.elements["fps1"];
const range = document.forms.modes.elements["range"];

var checker = document.getElementById('fps');
checker.onchange = function() {
  viewer.scene.debugShowFramesPerSecond = !!this.checked;
};
...
var viewModel = {
  ...
  debugFramesPerSecondEnabled: false,
...
function loadTileset(url) {
  ...
  tileset.debugShowBoundingVolume =
    ...
    tileset.debugShowFramesPerSecond =
    viewModel.debugFramesPerSecondEnabled;
  ...
  return tileset.readyPromise
    ...
    tileset.debugShowFramesPerSecond = fps.checked;
            if(tileset.debugShowFramesPerSecond) {
        tileset.debugShowFramesPerSecondEnabled = true;
      }
      else {
        tileset.debugShowFramesPerSecondEnabled = false;
      }
    };
...
Cesium.knockout
  .getObservable(viewModel, "debugFramesPerSecondEnabled")
  .subscribe(function (value) {
    if (Cesium.defined(tileset)) {
      tileset.debugShowFramesPerSecond = value;
    }
  });
